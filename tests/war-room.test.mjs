...
const engine=fs.readFileSync(new URL("../lib/unified-core.mjs",import.meta.url),"utf8");
...
test("browser uses the shared monthly specification",()=>{assert.match(page,/simulateUnified/);assert.match(page,/unified_spec\.json/)});
